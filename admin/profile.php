...
if (isset($_POST["edit_user"])) {
    ...
    $query = "UPDATE users SET user_firstname = '{$firstname}', user_lastname = '{$lastname}', username = '{$username}', user_email = '{$email}', user_password = '{$password}' WHERE username = '{$username}' ";
